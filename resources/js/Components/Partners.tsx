                  ...
                  <div className="p-1">
                    <Card>
                      <div className="flex aspect-square items-center justify-center p-4">
                         {client.logo ? (
                           <img src={client.logo.startsWith('/') || client.logo.startsWith('http') ? client.logo : `/storage/${client.logo}`} alt={client.name} className="w-full h-full object-contain" />
                         ) : (
                           <span className="text-xs font-bold text-muted-foreground text-center">{client.name}</span>
                         )}
                      </div>
                    </Card>
                  </div>
